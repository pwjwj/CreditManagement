   ...
   <div class="reg-title title1" style="background-image:url('./bilibili/t3.png')"></div>
    ...
    <s:form action="modifyCreditCategory.action" theme="simple">
        ...
        <div class="box center_div">
			...
			<s:textarea name="prepairToChangeCategory.categoryId" placeholder="分类号" value="%{#request.currentCreditCategory.categoryId}"  cssStyle="margin-bottom: 0;height: 40px;width: 300px;"/>
        </div>
        ...
        <div class="box center_div">
			...
			<s:textarea name="prepairToChangeCategory.categoryName" placeholder="分类名" value="%{#request.currentCreditCategory.categoryName}" cssClass="password user_id_password" cssStyle="margin-bottom: 0;height: 40px;width: 300px;"/>
        </div>
        <div class="box center_div">
         	 
			<s:textarea name="prepairToChangeCategory.detail" placeholder="详情" value="%{#request.currentCreditCategory.detail}" cssClass="password user_id_password" cssStyle="margin-bottom: 0;height: 40px;width: 300px;"/>
        </div>
        <div class="box center_div">
			<s:textarea name="prepairToChangeCategory.score" placeholder="分数" value="%{#request.currentCreditCategory.score}" cssClass="password user_id_password" cssStyle="margin-bottom: 0;height: 40px;width: 300px;"/>
        </div>
